...
**Metronomo is provided "as is" and "as available", without warranty of any kind**, express
...
while the app is free, is nothing) or **USD $50**.

Some jurisdictions do not allow the exclusion of certain warranties or the limitation of
certain damages. Where that is so, the exclusions and limitations above apply only to the
extent permitted, and nothing here limits liability for death or personal injury caused by
negligence, for fraud, or for anything else that cannot lawfully be limited. You may also
have statutory consumer rights that these terms do not affect.

## 7. Privacy

Our handling of data is described in the [Privacy Policy](/privacy), which forms part of
these terms.
